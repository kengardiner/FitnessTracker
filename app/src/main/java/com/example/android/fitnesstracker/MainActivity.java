...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadDetailActivity(String exerciseTitle) {
        Intent intent = new Intent(MainActivity.this, DetailsActivity.class);//Can send messages to operating system...activity manager where from what do you want to load?
        intent.putExtra(MainActivity.EXTRA_ITEM_TITLE, exerciseTitle);//Send title
